...
localStorage.setItem('page', 'LOGIN');
    ...
    return (
        ...
        <div className="bg-[#c44cff]/20  flex  flex-col  items-center h-auto h-auto w-full max-w-[400px] min-h-[600px]  shrink-0 border-[2px] border-[#c44cff] rounded-[12px] p-[20px]">
            ...
            <section className="flex flex-col gap-[20px]  w-full bg-red-500/10  ">
                <div className="flex flex-col  ">
                    ...
                    <div className="relative flex items-center w-full ">
                        ...
                        <input
                            ...
                            className="rounded-[10px] font-orbitron   caret-[#ff44ff] w-[100%] h-[45px]   bg-[#0b0618]  outline-none border-[2px] border-[#c44cff] placeholder:text-[#ff44ff]/40    transition-all" autoComplete="off" spellCheck="false" type="email" placeholder="Enter your email" value={gmailogin} onChange={(e) => setgmailogin(e.target.value)} ></input>
                    </div>
                </div>
                <div className="flex flex-col  ">
                    ...
                    <div className="relative flex items-center w-full  ">
                        ...
                        <input
                            style={{ paddingLeft: '35px', color: 'white !important', WebkitTextFillColor: 'white' }} className=" font-orbitron  rounded-[10px] caret-[#ff44ff]  w-[100%] h-[45px]  bg-[#0d0221] text-white outline-none border-[2px] border-[#c44cff] placeholder:text-[#ff44ff]/40  transition-all" type="password" placeholder="Enter your password" autoComplete="off" spellCheck="false" value={passlogin} onChange={(e) => setpasslogin(e.target.value)}></input>

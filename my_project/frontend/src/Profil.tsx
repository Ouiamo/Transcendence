...
//             <img src={match.opp_username === 'AI' ? `${API_URL}/api/avatar/file/ia.png` : `${API_URL}/api/avatar/file/guest.png`}  alt="opponent" className="w-full h-full rounded-full object-cover bg-[#1a1033]" />
//           </div>
//           <div className="flex flex-col">
